...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex justify-center h-screen items-center bg-blue-light font-inter">
      <Head>
        <title>Newsletters for Vegan News</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
        <section className="bg-blue-dark hidden lg:block w-1/2 rounded-l-lg">
          <img className="p-6 m-auto" src="images\undraw-cooking.svg" alt="Two persons cooking" />
        </section>

        <section className="bg-white p-10 gap-6 flex flex-col rounded-lg | 
          lg:w-1/2 justify-center lg:rounded-l-none">

          <div className="self-center relative group">
            <svg className="fill-blue-dark absolute top-0 left-1 opacity-0 | 
            ...
            <svg className="w-12 h-12 fill-blue-light stroke-blue-dark |
                group-hover:animate-bell" viewBox="0 0 24 24"
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 mb-2">
              Receive news about veganism, food in Brazil and recipes.
            </p>
          </div>

          <form action="#">
            <label className="text-sm font-bold text-gray-700 mb-2" htmlFor="email">Email</label>
            <input className="text-sm w-full mb-4 pl-3 rounded border py-2 shadow |
              focus:outline-none hover:border-blue-light hover:ring-1 hover:ring-blue-dark |
              focus:border-blue-dark focus:ring-1 focus:ring-blue-dark" id="email" placeholder="Digite seu email" value={email} onChange={(e) => setEmail(e.target.value)} />
            <button className="font-bold text-white bg-blue-dark w-full py-2 rounded-full shadow-xl |
            hover:bg-blue-hover duration-150">Inscreva-se</button>
          </form>
        </section>
      </main>
    </div>
